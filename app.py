...
name=Label(root,font=('ariel',15,'bold'),fg="#8a5f0a")
name.place(x=30,y=100)
clock=Label(root,font=('Helvetica',20),fg="#d90d3d")
...
t=Label(font=("ariel",70,"bold"),fg="#0b6e04")
t.place(x=400,y=150)
c=Label(font=("ariel",15,'bold'),fg="#0b6e04")
c.place(x=400,y=250)
